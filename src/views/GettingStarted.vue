      ...
      <template v-slot:content>
        <v-row>
          <v-col cols="12" md="8" class="mx-auto">
            ...
            <p :class="pClass">
              On this page are a few basic instructions to get you started with COMPAS on your system. Since we
              recommend using COMPAS in combination with the
              <a href="https://www.anaconda.com/download"> free Python distribution Anaconda </a>, the installation
              instructions are written for <span v-html="conda"></span>, the package and environment manager of
              Anaconda. If you need help getting started with <span v-html="conda"></span>, there are many good
              tutorials available online; for example here:
        ...
        <v-row class="mt-16">
          <v-col cols="12" md="8" class="mx-auto">
            ...
            <p :class="pClass">
              To install COMPAS with <span v-html="conda"></span> in an environment named "compas-dev", use the
              following command.
            </p>
...
'2.0.0'
        ...
        <v-row class="mt-16">
          <v-col cols="12" md="8" class="mx-auto">
            ...
            <p :class="pClass">
              As a basic example, we create a mesh from a unit-sized box geometry, apply catmull-clark subdivision, and
...
>>>> Box(1).to_mesh().subdivided(steps=3).to_obj('ball.obj')
            ...
            <p :class="pClass">To exit the interpreter, don't forget to run the <code>exit</code> command.</p>
            ...
            <v-row>
              <v-col cols="12" md="4" class="d-flex flex-even">
                <v-card flat rounded="0" class="pa-4 bg-white d-flex flex-grow-1 flex-column">
                  ...
                  <v-card-text class="text-secondary">
                    Installation instructions, simple examples, basic tutorials about geometry and data structures,
                    instructions for working in CAD environments, ...
                  </v-card-text>
                  <v-card-actions class="align-self-end w-100">
                    <v-btn href="https://compas.dev/compas/latest/userguide" target="_blank"> Read more </v-btn>
                  </v-card-actions>
                </v-card>
              </v-col>
              <v-col cols="12" md="4" class="d-flex flex-even">
                <v-card flat rounded="0" class="pa-4 bg-white d-flex flex-grow-1 flex-column">
                  ...
                  <v-card-text class="text-secondary">
                    Examples of how to use COMPAS in combination with other tools and libraries for different AEC
                    applications.
                  </v-card-text>
                  <v-card-actions class="align-self-end w-100">
              ...
              <v-col cols="12" md="4" class="d-flex flex-even">
                <v-card flat rounded="0" class="pa-4 bg-white d-flex flex-grow-1 flex-column">
                  ...
                  <v-card-text class="text-secondary">
                    The COMPAS framework has a core library and many optional extension packages for specific AEC
                    applications and workflows.
                  </v-card-text>
                  <v-card-actions class="align-self-end w-100">
                    <v-btn :to="{ name: 'Documentation' }"> Read more </v-btn>
                  </v-card-actions>
                </v-card>
              </v-col>
            </v-row>
